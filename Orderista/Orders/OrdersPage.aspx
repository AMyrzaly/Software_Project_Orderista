...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="text-align: center; margin-top: 20px;">
        ...
        <asp:GridView CssClass="table table-bordered table-dark menu_selection" ID="MenuGridView" runat="server"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Qty">
                    <ItemTemplate>
                        <asp:DropDownList ID="QtyList" runat="server" CssClass="form-control">
    ...
    <div style="display: flex; justify-content: center; flex-direction: column; color: black; font-weight: 400; align-items: center; margin: 0 auto; width: 800px;">
        <div class="timer">
            <asp:Timer ID="TimerTime" runat="server" Interval="1000" OnTick="TimerTime_Tick">
            </asp:Timer>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <label><b>Current time:</b></label>
